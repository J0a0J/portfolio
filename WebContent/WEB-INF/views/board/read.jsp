				...
				<c:if test="${not empty memberList }">
					<div class="clearfix mb-80">
						<div class="border-bottom-1 border-top-1 p-12">
							<span class="float-right fs-10 mt-10 text-muted">${memberList.createDtm}</span>
							<center>
								<strong>${memberList.title}</strong>
							</center>
						</div>
						<div class="block-review-content">
							<div class="block-review-body">
								<div class="block-review-avatar text-center">
									...
									<small class="block">${memberList.memberNick }</small>
									<hr />
								</div>
								<p>${memberList.content }</p>
				</c:if>
			...
			<div class="row">
				<div class="col-md-12 text-right">
					<c:if test="${ true }">
						...
						<a
							href="javascript:movePage('/board/delete.do?boardSeq=${boardSeq }')">
