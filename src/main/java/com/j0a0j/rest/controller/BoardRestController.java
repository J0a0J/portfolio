...
public class BoardRestController {
	...
	public ModelAndView readWriting(@RequestParam("boardSeq") int boardSeq, @ModelAttribute("BoardDto") BoardDto bDto) {
		...
		System.out.println("Current Page " + bDto.getPage());
...
//	@ResponseBody // !!!!!!!!!!!! 비동기 응답 
	...
	public HashMap<String, Object> update(@ModelAttribute("BoardDto") BoardDto bDto, @RequestPart(value="attFiles", required=false) MultipartHttpServletRequest mReq) {
